...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Outfit', sans-serif; }
        ...
        .msg { background: rgba(46, 213, 115, 0.1); border: 1px solid rgba(46, 213, 115, 0.3); color: #2ed573; padding: 10px; border-radius: 8px; margin-bottom: 20px; font-size: 0.9rem; }
        .error { background: rgba(255, 71, 87, 0.1); border: 1px solid rgba(255, 71, 87, 0.3); color: #ff4757; padding: 10px; border-radius: 8px; margin-bottom: 20px; font-size: 0.9rem; }
...
<body>
    ...
    <div class="glass">
        ...
        <a href="login.jsp" class="link">Already have an account? <b>Login</b></a>
    </div>
</body>
</html>